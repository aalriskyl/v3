...
import { pegawaiColumns } from "./columns/_columns";
import { Pegawai } from "../../molecules/core/_models";
import { KTCardBody } from "@metronic/helpers";
import { ListPagination } from "@metronic/layout/components/form/components/pagination/ListPagination";
import { getPegawai } from "../../core/_request";
import { useEmployees } from "../../core/EmployeeProviderContext";
import OverlayLoader from "@metronic/layout/components/OverlayLoader";

const Table: React.FC = () => {
  const { data, isLoading, pagination, totalData, setPagination } =
    useEmployees();

  const columns = useMemo(() => pegawaiColumns, []);
        ...
        >
          ...
          <tbody className="text-gray-600">
            {isLoading ? (
              ...
              table.getRowModel().rows.map((row: Row<Pegawai>) => {
