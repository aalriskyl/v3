...
interface EditPaymentTermsModalProps {
  show: boolean;
  handleClose: () => void;
  id: string;
}
    ...
    if (show && id) {
      ...
      axiosInstance
        ...
        .then((res) => {
          ...
          setValue("name", name);
          setValue("credit_days", credit_days);
          setValue("description", description);
          setValue("due_date_based_on", due_date_based_on);
          setValue("invoice_portion", invoice_portion);
        })
        .catch(() => {
