...
import { usePaymentTerms } from "../core/PaymentTermsContext";
// import FilterModal from '../modals/FilterModal';
// import { AddStockModal } from '../modals/AddMaterialModal';

const SectionPaymentTermsDetailSearch: React.FC = () => {
  const { setSearchTerm, setPagination } = usePaymentTerms();
...
export { SectionPaymentTermsDetailSearch };
