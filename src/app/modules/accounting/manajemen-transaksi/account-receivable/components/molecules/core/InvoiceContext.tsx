...
export const InvoiceProvider: React.FC<{
  ...
  const fetchUrl = "/sales/submission/sales-invoice/";
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      const response = await axiosInstance.get(
        `${fetchUrl}?status=Approved&sales_order_id=${sales_order_id}&search=${searchTerm}`,
        {
          params: {
      ...
      setData(invoice.data.sales_invoices);
