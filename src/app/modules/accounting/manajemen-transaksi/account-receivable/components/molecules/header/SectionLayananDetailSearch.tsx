...
import { useLayanan } from "../core/LayananContext";
// import FilterModal from '../modals/FilterModal';
// import { AddStockModal } from '../modals/AddMaterialModal';

const SectionLayananDetailSearch: React.FC = () => {
  const { setSearchTerm, setPagination } = useLayanan();
...
export { SectionLayananDetailSearch };
