...
import { useInvoice } from "../core/InvoiceContext";
// import FilterModal from '../modals/FilterModal';
// import { AddStockModal } from '../modals/AddMaterialModal';

const SectionInvoiceDetailSearch: React.FC = () => {
  const { setSearchTerm, setPagination } = useInvoice();
...
export { SectionInvoiceDetailSearch };
