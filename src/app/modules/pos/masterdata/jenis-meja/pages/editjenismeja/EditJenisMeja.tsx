...
import JenisMejaForm from '../../components/template/JenisMejaForm';

const EditJenisMeja: FC = () => {
    const { id } = useParams<{ id: string }>();
    const navigate = useNavigate();
    const [jenisMeja, setJenisMeja] = useState<Category | null>(null);
        ...
        const fetchSupplier = async () => {
            if (id) {
                try {
                    ...
                    setJenisMeja(response.data.data);
