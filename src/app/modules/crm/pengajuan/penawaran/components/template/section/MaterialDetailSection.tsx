...
import { useService } from "../../molecules/core/ServiceContext";
...
const MaterialDetailTableSection = ({
  ...
  const { data, isLoading, pagination, totalData, setPagination, fetchData} = useService()
  const { id } = useParams<{ id: string }>();


  const columns = useMemo(
    () => materialColumnsList(supplier_id, fetchData, status),
    [supplier_id, data, status]
  );
  ...
  return (
    <>
      ...
      <AddMaterialModal
        ...
        onSubmit={fetchData} // Pass the refetchData function
        onSuccess={fetchData}
