...
export const getAllServiceQuotation = async (
  id?: string,
  search: string = "",
  page?: number,
  size?: number,
  ...
  try {
    const response = await axiosInstance.get(
      `/crm/submission/quotation/quotation-service/quotation/${id}`,
      {
        params: {
          page,
          size,
...
export const getAllPenawaran = async (
  search: string = "",
  status?: string,
  page?: number,
  size?: number,
