...
import { UsersListSearchComponent,  UsersListSearchMaterialDetailComponent } from './UsersListSearchComponent'
...
export { TableListHeader,  TableListMaterialDetailHeader }
