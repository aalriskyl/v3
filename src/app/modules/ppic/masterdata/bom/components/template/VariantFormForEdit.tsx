...
import { VariantSectionFinishGoodsForEdit } from './section/VariantSectionFinishGoodsForEdit';
import ConfirmModal from '@metronic/layout/components/form/organism/ConfirmModal';
import SuccessModal from '@metronic/layout/components/form/organism/SuccessModal';
import { FailedModal } from '@metronic/layout/components/form/organism/FailedModal';
// import { ServiceSection } from './section/ServiceSection';
// import { UOMSection } from './section/RecipeSection';
...
const Form: FC<{ successMessage?: string; headTitle: string; buttonTitle: string; message: string, confirmButtonLabel: string, cancelButtonLabel: string }> = ({
    ...
    return (
        <div className="font-secondary">
            <form>
                <div className="">
                    <VariantSectionFinishGoodsForEdit
                        control={control}
