...
const UserActionsCellForEdit: FC<Props> = ({ id }) => {
  ...
  return (
    <>
      ...
      {/* Render Edit Material Modal */}
      <EditMaterialModal show={showEditModal} handleClose={handleCloseEditModal} onSubmit={handleSubmit} />

      {/* Render Detail Material Modal */}
      <DetailMaterialModal show={showDetailModal} handleClose={handleCloseDetailModal} handleDelete={() => console.log('Delete action')} />
    </>
  );
};

export { UserActionsCellForEdit };
