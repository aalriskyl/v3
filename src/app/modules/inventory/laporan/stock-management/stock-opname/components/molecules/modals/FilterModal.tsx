...
import { useStockOpnames } from "../../../../../../pengajuan/stock-management/stock-opname/components/molecules/core/StockOpnameContext";
...
const FilterModal: FC<FilterModalProps> = ({ closeModal }) => {
    const { setSubmittedDate, setSubmittedDateTo, setApprovedDate, setApprovedDateTo, setStatus, submittedDate, submittedDateTo, approvedDate, approvedDateTo, status } = useStockOpnames();
