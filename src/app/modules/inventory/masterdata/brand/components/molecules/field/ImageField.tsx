...
const ImageField: FC<ImageFieldProps> = ({ label, onChange, errors, defaultValue }) => {
    ...
    const handleFileChange = (file: File | null) => {
        if (file) {
            ...
            if (!validTypes.includes(file.type)) {
                alert('Format file tidak valid. Harap unggah file dengan format gambar yang valid.');
                return;
            }
    ...
    return (
        <div className="mb-3">
            ...
            <div
                className={`dropzone d-flex form-control align-items-center justify-content-center p-12 ${isDragging ? 'dropzone-dragover' : ''}`}
                ...
                {preview ? (
                    ...
                    <div className="text-center d-flex flex-column align-items-center justify-content-center">
                        ...
                        <span className="fs-6 fw-normal text-gray-500">
                            Unggah file dengan format jpg, jpeg, png, gif, bmp, tiff, tif. Maksimal file 15MB.
                        </span>
                    </div>
                )}
            </div>
