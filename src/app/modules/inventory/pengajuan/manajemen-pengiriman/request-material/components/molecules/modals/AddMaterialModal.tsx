...
export const AddMaterialModal = ({ show, handleClose, onSubmit, supplier_id, material_request_id }: AddMaterialModalProps) => {
    ...
    // Handle form submission for "Save & Add New"
    const handleFormSubmit = async (data: MaterialFormData) => {
        ...
        try {
            ...
            const response = await axiosInstance.post(
                `/inventory/submission/delivery-management/material-request/material-request-material/${material_request_id}`,
                payload
            );
