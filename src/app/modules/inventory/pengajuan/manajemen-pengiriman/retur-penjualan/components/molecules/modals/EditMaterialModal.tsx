...
export const EditMaterialModal = ({
  ...
  useEffect(() => {
    if (id) {
      ...
      axiosInstance
        .get(
          `/inventory/submission/delivery-management/retur-sales/retur-sales-material/${id}`
        )
        .then((response) => {
    ...
    async (data: MaterialFormData) => {
      ...
      try {
        ...
        const response = await axiosInstance.put(
          `/inventory/submission/delivery-management/retur-sales/retur-sales-material/${id}?company_id=${localStorage.getItem(
            "company_id"
          )}`,
          payload
        );
