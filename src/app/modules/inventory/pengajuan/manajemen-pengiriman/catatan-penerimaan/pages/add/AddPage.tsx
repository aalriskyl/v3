...
const AddPage: FC = () => {
    ...
    return (
        <>
            {/* Breadcrumb Header */}
            <PageTitle breadcrumbs={breadcrumbs}>Tambah Catatan Penerimaan</PageTitle>
            <Form
                mode='create'
                successMessage='Catatan Penerimaan berhasil di tambah'
                headTitle='Tambah Catatan Penerimaan'
                buttonTitle='Tambah'
