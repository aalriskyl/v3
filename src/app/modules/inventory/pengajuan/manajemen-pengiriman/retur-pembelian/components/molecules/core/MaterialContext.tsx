...
export const MaterialProvider: React.FC<{
  ...
  const fetchUrl =
    "/inventory/submission/delivery-management/retur-purchase/retur-purchase-material/retur-purchase";
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      setData(materials.data.retur_purchase_materials);
      setTotalData(materials.data.total_page * pagination.pageSize);
      console.log("materials", materials.data.retur_purchase_materials);
    } catch (err) {
