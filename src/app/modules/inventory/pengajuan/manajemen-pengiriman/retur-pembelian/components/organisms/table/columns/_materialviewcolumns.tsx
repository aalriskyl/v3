...
const materialViewColumns: ColumnDef<any>[] = [
  {
  ...
  {
    header: (props) => (
      <MaterialCustomHeader title="Jumlah" className="w-200px" />
    ),
    id: "amount",
    accessorKey: "amount",
  },
  {
    header: (props) => (
      <MaterialCustomHeader title="Jumlah Diretur" className="w-200px" />
    ),
    id: "amount_retur",
