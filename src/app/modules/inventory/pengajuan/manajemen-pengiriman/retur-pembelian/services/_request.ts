...
export const getPlanProduction = async (search = "") => {
  try {
    const response = await axiosInstance.get(`/inventory/pengajuan/manajemen-perngiriman/catatan-pengririman/${search}`);
...
export const getPlanProductionById = async (id: string) => {
  try {
    const response = await axiosInstance.get(`/inventory/pengajuan/manajemen-perngiriman/catatan-pengririman/${id}`);
...
export const createPlanProduction = async (data: any) => {
  try {
    const response = await axiosInstance.post("/inventory/pengajuan/manajemen-perngiriman/catatan-pengririman", data);
...
export const updatePlanProduction = async (id: string, data: any) => {
  try {
    const response = await axiosInstance.put(`/inventory/pengajuan/manajemen-perngiriman/catatan-pengririman/${id}`, data);
    return response.data.data.planproduction;
  } catch (error) {
...
export const deletePlanProduction = async (id: string) => {
  try {
    const response = await axiosInstance.delete(`/inventory/pengajuan/manajemen-perngiriman/catatan-pengririman/${id}`);
    return response.data.data.planproduction;
  } catch (error) {
