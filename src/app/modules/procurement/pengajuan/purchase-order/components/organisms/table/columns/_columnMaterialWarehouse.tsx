...
import { MaterialActionsCellWarehouse } from './MaterialActionsCellWarehouse'

const materialColumnsWarehouse = (status: string): ColumnDef<MaterialModelWarehouse>[] => [
    {
    ...
    {
        header: (props) => <UserCustomHeader title="Material" className="w-172px" />,
        id: 'material.name',
        accessorKey: 'material.name',
    },
    {
        header: (props) => <UserCustomHeader title="Konversi Material" className="w-172px" />,
        id: 'conversion_material.name',
        accessorKey: 'conversion_material.name',
    },
    {
        header: (props) => <UserCustomHeader title="Jumlah" className="w-172px" />,
        id: 'amount',
        accessorKey: 'amount',
    },
    {
    ...
    },
    {
        ...
        id: 'actions',
        cell: (info) => <MaterialActionsCellWarehouse status={status} id={info.row.original.id} />,
    },
];

export { materialColumnsWarehouse };
