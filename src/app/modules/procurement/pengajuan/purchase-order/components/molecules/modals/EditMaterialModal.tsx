...
export const EditMaterialModal = ({ show, handleClose, purchaseOrderId, onSuccess }: EditMaterialModalProps) => {
        ...
        const fetchMaterialData = async () => {
            if (show && purchaseOrderId) {
                try {
                    ...
                    const materialData = response.data; // Adjust based on actual API response structure
