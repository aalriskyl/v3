...
const DetailPage: FC = () => {
  ...
  const getDetail = async () => {
    ...
    try {
      ...
      setValue(
        "payment_purchase_invoice_id",
        payment_purchase_invoice?.id || null
      );
  ...
  const handleChangeStatusAction = async () => {
    ...
    try {
      ...
      await axiosInstance.put(
        `/sales/submission/payment-sales-invoice/status/${id}`,
        {
          status: changeStatus,
        }
      );
  ...
  const handleEdit = () => {
    navigate(`/sales/pengajuan/pembayaran-faktur-penjualan/edit/${id}`);
  };
    ...
    <>
      ...
      <div className="position-relative">
        <PageTitle breadcrumbs={breadcrumbs}>
          Detail Pembayaran Faktur Penjualan
        </PageTitle>
        <div
      ...
      <div className="font-secondary">
        <div className="card p-5 w-100 mb-8">
          <h3 className="mb-6">Pembayaran Faktur Penjualan</h3>
          <div className="row">
            <div className="col-md-6">
              <div>
                <label className="form-label fw-bold">
                  Nomor Pembayaran Faktur Penjualan
                </label>
            ...
            <div className="col-md-6">
              <div>
                ...
                <p className="text-lg font-medium">
                  {data?.payment_purchase_invoice
                    ?.no_payment_purchase_invoice || "-"}
                </p>
              </div>
              <div>
        ...
        <div className="card p-5 w-100 mt-8">
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              ...
              <span>{data?.sales_payment_terms?.invoice_portion}%</span>
            </div>
          </div>
          <div className="row mt-8">
            <div className="col-md-6">
              ...
              <span>
                {data?.sales_payment_terms?.due_date
                  ? formatDateToMonthYear(data?.sales_payment_terms?.due_date)
                  : "-"}
              </span>
            </div>
          </div>
          ...
          <div className="row align-items-center">
            <div className="col-md-6">
              <div className="mb-2">
                ...
                <span>{data?.sales_invoice?.percent_tax || "-"}% </span>
              </div>
            </div>
            <div className="col-md-6">
              <div className="mb-2">
                ...
                <span>{data?.sales_invoice?.percent_income_tax || "-"}%</span>
              </div>
            </div>
            <div className="col-md-6">
              <div className="d-flex flex-column h-100 justify-content-center">
                ...
                <p className="text-lg font-medium m-0">
                  Rp.{formatDecimal(data?.sales_invoice?.nominal_tax)}
                </p>
              </div>
            </div>
            <div className="col-md-6">
              <div className="d-flex flex-column h-100 justify-content-center">
                ...
                <p className="text-lg font-medium m-0">
                  Rp.{formatDecimal(data?.sales_invoice?.nominal_income_tax)}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-md-12 align-items-center">
              <div className="g-2 mb-5 d-flex justify-content-between align-items-center">
                ...
                <h6>
                  Rp.
                  {formatDecimal(data?.sales_invoice.total_purchase_material)}
                </h6>
              </div>
              <div className="g-2 mb-5 d-flex justify-content-between align-items-center">
                <div className="text-gray-500">
                ...
                <h6>
                  Rp.{formatDecimal(data?.sales_invoice.total_purchase_service)}
                </h6>
              </div>
              <div className="g-2 mb-5 d-flex justify-content-between align-items-center">
                <div className="text-gray-500">
                ...
                <h6>
                  Rp.{formatDecimal(data?.sales_invoice.sub_total_material)}
                </h6>
              </div>
              <div className="g-2 mb-5 d-flex justify-content-between align-items-center">
                <div className="text-gray-500">
                ...
                <h6>
                  Rp.{formatDecimal(data?.sales_invoice.sub_total_service)}
                </h6>
              </div>
              ...
              <div className="g-2 mb-5 d-flex justify-content-between align-items-center">
                ...
                <h6>
                  Rp.
                  {formatDecimal(data?.sales_invoice.sub_total)}
                </h6>
              </div>
              <div className="g-2 mb-5 d-flex justify-content-between align-items-center">
                <div className="text-gray-500">
                ...
                <h6>Rp.{formatDecimal(data?.sales_invoice.sub_total_tax)}</h6>
              </div>
              <div className="g-2 mb-5 d-flex justify-content-between align-items-center">
                <div className="text-gray-500">
                  <span>Nominal Pembulatan</span>
                </div>
                <h6>Rp.{formatDecimal(data?.sales_invoice.total_ceil)}</h6>
              </div>
              ...
              <div className="g-2 mb-5 d-flex justify-content-between align-items-center">
                ...
                <h4 className="fw-bolder">
                  Rp.{formatDecimal(data?.sales_invoice.grand_total)}
                </h4>
              </div>
              <div className="g-2 mb-5 d-flex justify-content-between align-items-center">
                <div className="text-gray-500">
              ...
              <div className="g-2 mb-5 d-flex justify-content-between align-items-center">
                ...
                <h6>Rp.{formatDecimal(data?.sales_invoice.total_paid)}</h6>
              </div>
              ...
              <div className="g-2 mb-2 d-flex justify-content-between align-items-center">
                ...
                <h5 className="fw-bolder">
                  Rp.
                  {formatDecimal(
                    (data?.sales_invoice.grand_total || 0) -
                      (data?.sales_invoice.total_paid || 0)
                  )}
                </h5>
              </div>
            </div>
