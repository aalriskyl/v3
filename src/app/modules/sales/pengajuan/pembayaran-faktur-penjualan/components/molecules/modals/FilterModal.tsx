...
import { usePembayaranFakturPenjualan } from "../../../core/useContextView";
...
const FilterModal: FC<FilterModalProps> = ({ closeModal }) => {
    const { setSubmittedDate, setSubmittedDateTo, setApprovedDate, setApprovedDateTo, setStatus, submittedDate, submittedDateTo, approvedDate, approvedDateTo, requestedDate, requestedDateTo, setRequestedDate, setRequestedDateTo, status } = usePembayaranFakturPenjualan();
