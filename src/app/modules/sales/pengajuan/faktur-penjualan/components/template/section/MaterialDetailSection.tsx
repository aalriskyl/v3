...
import { useMaterialSalesOrderFaktur } from "../MaterialDetailSectionLayout";

interface MaterialDetailTableSectionProps {
  returPresent?: string | null;
}

const MaterialDetailTableSection = ({
  returPresent,
}: MaterialDetailTableSectionProps) => {
  const { materialData, totalData, pagination, setPagination } =
  ...
  const columns = useMemo(
    () => materialDetailColumns(returPresent),
    [returPresent]
  );
