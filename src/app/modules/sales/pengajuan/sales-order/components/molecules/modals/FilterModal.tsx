...
import { useRequestOrders } from "../core/RequestOrderContext";
...
const FilterModal: FC<FilterModalProps> = ({ closeModal }) => {
    const { setSubmittedDate, setSubmittedDateTo, setApprovedDate, setApprovedDateTo, setStatus, submittedDate, submittedDateTo, approvedDate, approvedDateTo, status } = useRequestOrders();
